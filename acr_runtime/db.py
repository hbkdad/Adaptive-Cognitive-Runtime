...
class RuntimeDB:
    ...
    def _migrate(self) -> None:
        ...
        schema = """
            ...
            __EVALUATION_SCHEMA__
            __REFLECTION_SCHEMA__
            __LEARNING_SCHEMA__
            ...
            __REGRESSION_SCHEMA__
            __SKILL_BENCHMARK_SCHEMA__
            ...
            __REASONING_BUDGET_SCHEMA__
            __PARALLEL_RESEARCH_SCHEMA__
            ...
            __PROCEDURE_DETECTION_SCHEMA__
        ...
        self.connection.executescript(
            schema.replace("__MEMORY_SCHEMA__", memory_schema).replace(
                ...
                "__EVALUATION_SCHEMA__", MIGRATION_24_SQL
            ).replace(
                "__REFLECTION_SCHEMA__", MIGRATION_25_SQL
            ).replace(
                "__LEARNING_SCHEMA__", MIGRATION_26_SQL
            ).replace(
                ...
                "__REGRESSION_SCHEMA__", MIGRATION_36_SQL
            ).replace(
                "__SKILL_BENCHMARK_SCHEMA__", MIGRATION_37_SQL
            ).replace(
                "__SKILL_LAB_SCHEMA__", MIGRATION_38_SQL
            ).replace(
                ...
                "__SAFE_CACHE_SCHEMA__", MIGRATION_45_SQL
            ).replace(
                ...
                "__REASONING_BUDGET_SCHEMA__", MIGRATION_54_SQL
            ).replace(
                "__PARALLEL_RESEARCH_SCHEMA__", MIGRATION_55_SQL
            ).replace(
                "__EVIDENCE_GRAPH_SCHEMA__", MIGRATION_56_SQL
            ).replace(
                ...
                "__PROCEDURE_DETECTION_SCHEMA__", MIGRATION_65_SQL
            )
        )
        applied_at = utc_now()
